...
from app.api.v1.endpoints import auth, ai, templates, workflows, analytics, knowledge, dashboard, system, organizations, users, permissions, agent, import_, local_ai, ai_capability, ai_digital_base, ai_agent_engine, doc_converter, notifications, data_model
...
api_router.include_router(data_model.router)  # 数据建模
